<div class="row-fluid">
        ...
        <form id="validation-form" class="form-horizontal" method="post" style="display: block;" novalidate="novalidate" action="">
            ...
            <div class="form-group <?=$model->hasErrors('img_url')?'has-error':''?>">
                <label for="img_url" class="control-label col-xs-12 col-sm-3 no-padding-right"><?=$model->getAttributeLabel('img_url')?></label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" class="col-xs-12 col-sm-6" id="img_url" name="form[img_url]" value="<?=$model->img_url?>" >
                    </div>
