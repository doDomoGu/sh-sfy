<div class="row-fluid">
        ...
        <form id="validation-form" class="form-horizontal" method="post" style="display: block;" novalidate="novalidate" action="">
            ...
            <div class="form-group <?=$model->hasErrors('describe')?'has-error':''?>">
                <label for="describe" class="control-label col-xs-12 col-sm-3 no-padding-right"><?=$model->getAttributeLabel('describe')?></label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" class="col-xs-12 col-sm-6" id="describe" name="form[describe]" value="<?=$model->describe?>" >
                    </div>
                    <?php if($model->hasErrors('describe')):?>
                        <div id="describe-error" class="help-block"><?=$model->getError('describe')?></div>
                    <?php endif;?>
                </div>
            </div>
